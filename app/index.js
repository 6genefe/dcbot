...
client.login('NTY2NjYzMDYzMjQ0MTExOTQx.XLLnyQ.vpJL2GKFDNG_XcXneJHS-HP1QoQ');

bot.on("ready", guild => {
    bot.user.setActivity('d!yardım', { type: 'PLAYING'  })
...
client.on('message', msg => {
  if (msg.content === 'd!yardım') {
    msg.reply('d!çal d!durdur d!çalan d!duraklat d!devam d!ses d!geç d!sıra');
...
bot.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Dürüm Bot | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Dürüm Bot | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**Dürüm| 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
